 ...
 */
public class SuperRelativeLayout extends AlphaRelativeLayout implements ILayout {
    private SuperLayoutHelper mLayoutHelper;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new SuperLayoutHelper(context, attrs, defStyleAttr, this);
    ...
    @Override
    public void setRadiusAndShadow(int radius, @SuperLayoutHelper.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    @Override
    public void setRadius(int radius, @SuperLayoutHelper.HideRadiusSide int hideRadiusSide) {
